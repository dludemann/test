...
<template>
  <section :data-cms-bind="dataBinding" class="font-display">
    ...
    >
      ...
      />
      <p
        class="text-[26px] font-body z-10 relative text-center tracking-[1px] leading-[44px] text-white"
      ...
      <h1
        ...
        class="z-10 relative text-[50px] font-body lg:text-[96px] lg:leading-[96px] text-center text-white max-w-[50rem] mx-auto"
        :style="{
          'text-wrap': 'balance',
