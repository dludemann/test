<template>
  <header class="text-center mt-8 font-bold text-body-large">
    <h1>The Match Artist Privacy Policy</h1>
  </header>

  <section class="privacy">
    <h2 class="mb-4">Last updated September 14, 2020</h2>

    <p>
      Thank you for choosing to be part of our community at The Match Artist
      ...
      <a href="mailto:info@thematchartist.com">info@thematchartist.com</a>.
    </p>

    <p>
      When you visit our website
      <a href="https://www.thematchartist.com/"
        >https://www.thematchartist.com/</a
      ...
      how we use it and what rights you have in relation to it. We hope you take
      some time to read through it carefully, as it is important. If there are
  ...
  <section>
    ...
    <p>
      <strong>Publicly Available Personal Information.</strong> We collect first
      name, maiden name, last name, and nickname; phone numbers; email
      addresses; business email; business phone number; and other similar data.
    </p>
    ...
    <p>
      <strong>In Short:</strong> Some information — such as IP address and/or
    ...
    <p>
      <strong>Online Identifiers.</strong> We collect cookie identifiers, or
    ...
    <ul>
      ...
      <li>
        <strong
          ...
          personal information in the following situations:</strong
        >
      </li>
  ...
  <section>
    ...
    <p>
      ...
      legal requirements). No purpose in this policy will require us to keep
  ...
  <section>
    ...
    <p>
      ...
      delete such data from our records. If you become aware of any data we have
  ...
  <section>
    ...
    <p>
      ...
      collection, use, disclosure or disposal of personal information. You will
      be notified about data breaches when The Match Arist believes you are
      ...
      physical well-being. In the event that he Match Arist becomes aware of a
      security breach which has resulted or may result in unauthorized access,
      use or disclosure of personal information, The Match Arist will promptly
      investigate the matter and notify the applicable Supervisory Authority not
  ...
  <section>
    ...
    <p>
      <strong>In Short:</strong> Most web browsers and some mobile operating
  ...
  <section>
    ...
    <p>
      <strong>In Short:</strong> Yes, we will update this policy as necessary to
  ...
  <section>
    ...
    <p>
      ...
      <a href="mailto:info@thematchartist.com">info@thematchartist.com</a> or by
      post to:
    </p>

    <address>
      The Match Artist<br />
      3400 Oak Grove Ave<br />
      Dallas, TX 75204<br />
      United States
    </address>
  </section>
  ...
  <section>
    ...
    <p>
      ...
      by clicking
      <a href="request_form_link">here</a>. We will respond to your request
      within 30 days.
    </p>
  </section>
</template>
