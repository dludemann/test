  ...
  <NuxtLayout>
    ...
    <section>
      <p class="max-w-[800px] mx-auto text-[18px] py-[50px] px-6">
        ...
        pictures possible. Having the photos professionally taken is only part
        of the process. We also help you learn how to look and pose so you can
    ...
    >
      <article class="p-[70px] flex flex-col items-start">
        ...
        <ul class="list-disc">
          ...
          <li class="text-[20px]">
            We'll shoot with you for 4-5 hours resulting in 200-300 edited
            photos.
          </li>
        </ul>
      </article>
    ...
    <section>
      <p class="max-w-[800px] mx-auto text-[18px] py-[50px] px-6">
        ...
        cities, please fill out the contact form and we will let you know when
        we are in a location near you.
      </p>
    </section>
