  ...
  <NuxtLayout>
    ...
    <section class="bg-black overflow-hidden">
      ...
      >
        ...
        >
          <img :src="heroImage" format="webp" alt="Smiling Man" />
        </div>
      </section>
    </section>
